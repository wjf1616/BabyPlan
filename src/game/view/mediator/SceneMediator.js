...
var SceneMediator = cc.GamePureMVC.define(
    // CLASS INFO
    {
    ...
    // INSTANCE MEMBERS
    {
        ...
        listNotificationInterests: function () {
            return [
                cc.GamePureMVC.statemachine.StateMachine.CHANGED
            ];
        },
        ...
        handleNotification: function (notification) {
            switch (notification.getName()) {
                case cc.GamePureMVC.statemachine.StateMachine.CHANGED:
